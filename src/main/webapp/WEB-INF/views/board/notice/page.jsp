                    ...
                    <div class="col-sm-10 col-sm-offset-1 profiel-container">
                        ...
                        <form action="" method="">
                            <div class="profiel-header">
                                ...
                                <div class="col-sm-3 padding-top-25" >
                                    ...
                                    <div class="form-group" style="padding: 10px 0 0; margin: 10px 0 0;width: 500px;">
                                        <label>제목</label>
                                        <input name="firstname" type="text" class="form-control" placeholder="제목을 입력해주세요">
                                    </div>
                                    <div class="form-group" style="padding: 10px 0 0; margin: 10px 0 0;width: 500px;">
                                        <label>작성자</label>
                                        <input name="lastname" type="text" class="form-control" placeholder="관리자">
                                    </div> 
                           ...
                           <br>
                            ...
                            <div class="col-sm-5 col-sm-offset-1">
                                <br>
                                <input type='button' class='btn btn-finish btn-primary' name='finish' value='게시글 저장' />
                                  
                            </div>
                            <br>
                             <div class="col-sm-5 col-sm-offset-1" style="margin: 0 0 0 0">
                   
                                <input type='button' class='btn btn-finish btn-primary'  name='secession' value='게시글 삭제' />
