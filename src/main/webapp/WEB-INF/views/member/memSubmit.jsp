		 		...
		 		$('#emailchk').on("click",function(){
		 			...
		 			if($('#mem_email').val()==""){
		 				...
		 				$.ajax({
		 					...
		 					data:"mem_email="+id,
		 					datatype:'json',
		 					url : '${contextPath}/member/emailConfirm',
            ...
            <div class="container">
                <div class="row">
                    <div class="page-head-content">
                        <h1 class="page-title">회원 가입페이지</h1>               
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="wizard-container"> 
                        ...
                        <div class="wizard-card ct-wizard-orange" id="wizardProperty">
                            <form action="${contextPath}/member/addMember" method="post">                        
								...
								<div class="container col-sm-9" style="text-align:left; padding-left:400px;">
									<div class="form-group" style="padding: 30px 0 0">
										<label>E-mail <small><button>중복테스트</button></small></label> 
										<input id="mem_email"name="mem_email" type="text" class="form-control"placeholder="">
									</div>
									...
									<div class="form-group">
										<label>비밀번호 확인 </label> <input name="pwd_chk" type="password"
											class="form-control" placeholder="">
									</div>
									<div class="form-group">
										<label>이름 <small></small></label> <input id="name" name="name"
											type="text" class="form-control" placeholder="">
									</div>
									<span class="form-group"> <label>생년월일<small>&nbsp;(커서로 클릭해주세요)</small></label> <input id="birth" name="birth" type="text"
										class="form-control" placeholder="" style="width: 40%">
									</span>

									<span class="from-group">  <a href="javascript:execDaumPostcode()">우편번호검색</a></span>
									<p>
										<label>우편번호</label> <input type="text" id="zipcode" name="zipcode" class="form-control" placeholder="">
							 	...
							 	<div class="col-sm-offset-4 col-sm-4" style="text-align:center;margin-top:10px;margin-bottom: 80px">
									<button class="btn" type="submit" id="membersave" name="membersave">회원가입</button>
